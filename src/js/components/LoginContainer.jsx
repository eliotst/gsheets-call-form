...
export default class LoginContainer extends React.Component {
    ...
    initClient() {
        ...
        gapi.client.init({
            ...
            clientId: "674412593540-cm4if09mdfebk5e6j4enf0skdgt6t483.apps.googleusercontent.com",
    ...
    render() {
        const { isLoggedIn, onUserChange, user } = this.props;
        ...
        return (
            <div>
                <UserContainer onUserChange={onUserChange} user={user} />
            </div>
        );
    }
}
